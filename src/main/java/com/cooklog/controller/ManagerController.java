...
public class ManagerController {
	 ...
	 */
	@Operation(summary = "관리자 계정 메인페이지로 이동")
	@ApiResponses({
	 ...
	 */
	@Operation(summary = "사용자 목록 조회", description = "시스템에 등록된 모든 사용자의 목록을 조회합니다.")
	@ApiResponses({
	 ...
	 */
	@Operation(summary = "사용자 등급 관리", description = "지정된 사용자 ID에 대한 등급 정보를 관리합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "사용자 등급 관리 페이지 접근 성공"),
		@ApiResponse(responseCode = "404", description = "사용자 정보가 존재하지 않음"),
		@ApiResponse(responseCode = "500", description = "서버 내부 오류")
	})
	 ...
	 * @return 리다이렉트 URL
	 */
	@Operation(summary = "사용자 등급 업데이트", description = "지정된 사용자의 등급을 업데이트합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "사용자 등급 업데이트 성공"),
	 ...
	 */
	@Operation(summary = "게시판 목록 조회", description = "시스템에 등록된 모든 게시판의 목록을 조회합니다.")
	@ApiResponses({
	...
	@ApiResponses({
		...
		@ApiResponse(responseCode = "500", description = "게시글 삭제 중 서버 내부 오류 발생")
	})
	 ...
	 * @return 댓글 관리 페이지 경로
	 */
	@Operation(summary = "댓글 목록 조회", description = "시스템에 등록된 모든 댓글의 목록을 조회합니다.")
	@ApiResponses({
	 ...
	 * @return 신고 관리 페이지 경로
	 */
	@Operation(summary = "신고된 내용 조회", description = "시스템에 신고된 모든 내용을 페이지 단위로 조회합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "신고된 내용 조회 성공"),
		@ApiResponse(responseCode = "500", description = "서버 내부 오류")
	})
	@GetMapping("/report")
	 ...
	 */
	@Operation(summary = "사용자 블랙리스트 추가", description = "지정된 사용자를 블랙리스트에 추가합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "유저를 블랙리스트에 추가하였습니다."),
	...
	public ResponseEntity<?> addToBlacklist(@PathVariable Long userId) {
		...
		return ResponseEntity.ok(Map.of("description", "유저를 블랙리스트에 추가하였습니다.", "isBlacklisted", isBlacklisted));
	}
	 ...
	 */
	@Operation(summary = "사용자 블랙리스트 제거", description = "지정된 사용자를 블랙리스트에서 해제합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "유저를 블랙리스트에서 해제하였습니다."),
		@ApiResponse(responseCode = "404", description = "해당 사용자가 존재하지 않음"),
		@ApiResponse(responseCode = "500", description = "서버 내부 오류")
	})
	...
	public ResponseEntity<?> removeFromBlacklist(@PathVariable Long userId) {
		...
		return ResponseEntity.ok(Map.of("description", "유저를 블랙리스트에서 해제하였습니다.", "isBlacklisted", isBlacklisted));
	}
	 ...
	 */
	@Operation(summary = "신고 페이지에 등록된 사용자 게시물 조회", description = "지정된 사용자의 게시물과 댓글을 조회합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "사용자 게시물 조회 성공"),
		@ApiResponse(responseCode = "404", description = "해당 사용자가 존재하지 않음"),
		@ApiResponse(responseCode = "500", description = "서버 내부 오류")
	})
	 ...
	 */
	@Operation(summary = "댓글 신고", description = "지정된 댓글을 신고합니다.")
	@ApiResponses({
	 ...
	 */
	@Operation(summary = "게시판 검색", description = "주어진 조건으로 게시판을 검색합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "게시판 검색 성공"),
		@ApiResponse(responseCode = "500", description = "서버 내부 오류")
	})
	 ...
	 */
	@Operation(summary = "댓글 검색", description = "주어진 조건으로 댓글을 검색합니다.")
	@ApiResponses({
	 ...
	 * @return 신고 관리 페이지 경로
	 */
	@Operation(summary = "신고된 유저 검색", description = "닉네임으로 신고된 유저를 검색합니다.")
	@ApiResponses({
		@ApiResponse(responseCode = "200", description = "신고된 유저 검색 성공"),
		@ApiResponse(responseCode = "500", description = "서버 내부 오류")
	})
	 ...
	 */
	@Operation(summary = "사용자 검색", description = "주어진 조건으로 사용자를 검색합니다.")
	@ApiResponses({
